...
function pkproject(){
	...
	oProject.table_cols = ['pId','pName','status','minSquare','maxSquare','minPrice','maxPrice','countryId','proviceId','cityId','districtId','fullAddr','prightId','handoverYear','handoverMonth','handoverDay','canLoan','totalSquare','totalAmount','predictYearRent','localPricePic','picture1','picture2','picture3','thumbnail','description','selected'];
	
	// 以下4个变量的长度必须一致！！！
	oProject.table_cross_fkey = [['countryId'],['pId'],['prightId']];	
