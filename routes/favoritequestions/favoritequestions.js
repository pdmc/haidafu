...
var FavoriteQuestion = require('../../models/favoritequestion/favoritequestion.js');

var favoriteQuestion = new FavoriteQuestion();

const table_name = favoriteQuestion.table_name; //'pkproject';
const table_cols = favoriteQuestion.table_cols; //'pkproject';
